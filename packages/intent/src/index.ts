...
function systemPrompt(spotHint?: number): string {
  return [
    ...
    "- capital.amount = the dollar amount the user wants to put in / risk, if they",
    "  state one. Examples: 'risk about $1.5' -> 1.5, 'use $5' -> 5, 'I can risk $10'",
    "  -> 10. If they state no amount, default to 2. TESTNET: never exceed 25.",
    "- risk.maxLossPct = a stated loss cap expressed as a percentage, e.g.",
    "  'cap loss at 7.5%' -> 7.5, 'limit downside to 10%' -> 10. Default 20 if unstated.",
